...
//#endregion
//#region src/components/custom/topline/topline.js
...
function initSliders() {
	if (document.querySelector(".hero-slider")) new Swiper(".hero-slider", {
		modules: [
			Navigation,
			Mousewheel,
			Pagination
...
function updateSlideCounter(swiperInstance) {
	...
	const counterElement = document.querySelector(".slider-bottom__count .slider-bottom__value");
	if (counterElement) counterElement.textContent = `${realIndex} / ${totalSlides}`;
	else console.warn("Element .slider-bottom__count .slider-bottom__value not found");
}
